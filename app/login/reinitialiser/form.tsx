      ...
      <div className="w-full max-w-[380px] bg-white rounded-2xl p-8 border border-border">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-semibold" style={{ color: brandColor }}>
            {verifying ? "Vérification..." : success ? "Mot de passe modifié" : tokenValid ? "Nouveau mot de passe" : "Lien invalide"}
          </h1>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {firstName && (
              <p className="text-sm text-gray-500 text-center mb-2">
                Bonjour <strong>{firstName}</strong>, choisissez votre nouveau mot de passe.
              </p>
            )}
            {error && (
