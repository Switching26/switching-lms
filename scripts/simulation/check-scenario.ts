...
function checkScenario(sc: SimulationScenario) {
  ...
  const KNOWN_CONTROLS = new Set([
    ...
    "aff-liberer-volets",
    "ui-nouvelle-feuille",
    "ins-graph-recommande",
    "ins-graph-histogramme",
    "ins-graph-barres",
    "ins-graph-courbes",
    "ins-graph-secteurs",
    "ins-graph-aires",
    "ins-graph-nuage",
    "ins-graph-element-titre",
    "ins-graph-element-titres-axes",
    "ins-graph-element-legende",
    "ins-graph-element-etiquettes",
    "ins-graph-element-quadrillage",
    "ins-graph-legende-droite",
    "ins-graph-legende-bas",
    "ins-graph-style-2",
    "ins-graph-style-3",
    "ins-graph-style-4",
    "ins-graph-style-5",
    "ins-graph-intervertir",
    "ins-graph-selectionner-donnees",
    "ins-graph-filtre-serie",
    "ins-graph-supprimer-serie",
    "ins-graph-modifier-type",
    "ins-graph-couleur-serie",
    "ins-graph-forme-serie",
    "ins-graph-tendance-lineaire",
    "ins-graph-tendance-moyenne-mobile",
    "ins-graph-tendance-supprimer",
    "mep-zone-impression-definir",
    "mep-zone-impression-annuler",
    "mep-imprimer-titres",
    "mep-saut-inserer",
    "mep-saut-supprimer",
    "mep-sauts-reinitialiser",
    "mep-orientation-portrait",
    "mep-orientation-paysage",
    "mep-format-a4",
    "mep-format-a3",
    "mep-format-letter",
    "mep-marges-normales",
    ...
    "mep-ajuster-largeur",
    "mep-ajuster-hauteur",
    "mep-quadrillage-imprimer",
    "mep-entetes-imprimer",
    "mep-centrer-horizontal",
    "mep-centrer-vertical",
    "mep-titres-lignes",
    "mep-titres-colonnes",
    "mep-entete-pied",
    "mep-panneau",
    ...
    "mep-code-feuille",
    "aff-mode-normal",
    "aff-mode-mise-en-page",
    "aff-mode-sauts-de-page",
    "tcd-actualiser",
    "tcd-champs",
    "dev-enregistrer-macro",
    "dev-arreter-enregistrement",
    "dev-macros",
    "dev-references-relatives",
    "mac-nom",
    "mac-raccourci",
    "mac-valider",
    "mac-annuler",
